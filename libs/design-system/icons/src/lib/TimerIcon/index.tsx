   ...
   return (
      <svg width={24} height={24} fill='none' viewBox='0 0 24 24' {...props}>
         <path
            fill='#3E4C59'
            fillRule='evenodd'
            d='M10.465 7.962a.5.5 0 01.498-.462h.085a.5.5 0 01.497.45L12 12.5l3.248 1.856c.156.09.252.255.252.434v.055a.5.5 0 01-.632.483l-4.47-1.22a.498.498 0 01-.366-.52l.433-5.626z'
            clipRule='evenodd'
         />
         <path
            fill='#3E4C59'
