...
const OutlineClipBoardTick = (props: IconPropsType): JSX.Element => {
  const {
    width = 24,
    height = 24,
    fill = colors['blue-gray-800'],
    ...rest
  } = props;
  return (
    <svg
...
export default OutlineClipBoardTick;
