...
function OutlineFlagSelectedIcon(props: IconPropsType): JSX.Element {
  const { width = 24, height = 24, fill = colors['blue-600'], ...rest } = props;
  return (
    <svg
      width={width}
      height={height}
...
export { OutlineFlagSelectedIcon };
