...
export const getButtonTextStyles = () => cn(``)
export const getPickerButtonClass = (
   ...
   return cn(
      ...
      { [`${theme.picker.disabled.styles}`]: isDisabled },
      {
...
export const getPlaceholderStyles = (size: BasicSize, theme: any) => {
   return cn(`${theme.picker.placeholderColor} ${placeholderTextSizes[size]}`)
}

export const clearIconContainerClassName = `absolute top-1/2 -translate-y-1/2 right-10`
