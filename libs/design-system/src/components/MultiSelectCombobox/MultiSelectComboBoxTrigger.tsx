...
const MultiSelectComboBoxTrigger = React.forwardRef(function ComboBoxInput(
      ...
      >
        <div className={cn(inputGroupContainerClassName)}>
          ...
          <div className={cn(inputContainerClassName)}>
            {renderValueContainer && (
              <div className="min-w-min flex item-center bg-transparent">
                {renderValueContainer({
...
export default MultiSelectComboBoxTrigger;
